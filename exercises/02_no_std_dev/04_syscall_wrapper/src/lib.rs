...
pub fn x86_64_abi() -> SyscallABI {
    ...
    // Hint: x86_64 uses the "syscall" instruction, syscall number in raxkey
    SyscallABI {
        arch: "x86_64",
        instruction: "syscall",
        id_reg: "rax",
...
pub fn riscv64_abi() -> SyscallABI {
    // Fill in the riscv64 syscall ABI
...
pub unsafe fn syscall3(id: usize, arg0: usize, arg1: usize, arg2: usize) -> isize {
    // Implement aarch64 syscall using core::arch::asm!
    // Hints:
    //   - "svc #0" instruction
    //   - in("x8") id
